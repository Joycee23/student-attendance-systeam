...
const validateRegister = [
  ...
  body("studentCode")
    ...
    .notEmpty()
    .withMessage("Student code is required for students"),

  body("lecturerCode")
    .if(body("role").equals("lecturer"))
    .notEmpty()
    .withMessage("Lecturer code is required for lecturers"),
...
const validateUpdateClass = [
  ...
  body("lecturerId").optional().isMongoId().withMessage("Invalid lecturer ID"),
...
const validateCreateSubject = [
  body("code")
    ...
    .withMessage("Subject code must be between 3 and 20 characters")
    .toUpperCase(),
  ...
  body("name")
    ...
    .withMessage("Subject name must be between 3 and 200 characters"),
...
const validateCreateSession = [
  ...
  body("sessionNumber")
    ...
    .isInt({ min: 1 })
    .withMessage("Session number must be at least 1"),
...
const validateUpdateSettings = [
  body("attendanceTimeout")
    .optional()
    .isInt({ min: 5, max: 480 })
    .withMessage("Attendance timeout must be between 5 and 480 minutes"),
  ...
  body("lateThreshold")
    .optional()
    .isInt({ min: 0, max: 60 })
    .withMessage("Late threshold must be between 0 and 60 minutes"),
